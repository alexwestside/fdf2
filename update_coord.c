...
void ft_coord_update_z(t_point **point_x, t_map **map_i, t_map **map_z)
{
	int i;
	int j;
...
void ft_coord_update_c(t_point **point_x, t_map **map_i, t_map **map_c)
{
	int i;
	int j;
...
void	ft_map_zero(t_mlx **mlx, t_map **map_i, t_map **map_z, t_map **map_c)
{
	...
	(*mlx)->zero->g = 0;
	(*mlx)->zero->b = 0;
	ft_coord_update_z(&(*mlx)->zero, map_i, map_z);
	ft_coord_update_c(&(*mlx)->zero, map_i, map_c);
